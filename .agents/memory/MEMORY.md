...
- [Profile completion gate](profile-completion-gate.md) — mandatory modal blocks app until firstName/lastName/age/sex/location filled; lives in Layout so it fires on any page post-login.
